...
const char* WIFI_NAME = "proteus-GUEST";
...
void loop(){
  ...
  {            
    ...
    if (pirState == LOW)    // we have just turned on
    {
      ...
      delay(500);
      mySerial.println("AT+CMGS=\"sending data to cloud\"\r"); // change to the phone number you using 
      delay(500);
      sendATCommand("AT+HTTPACTION=1") // sending signal to clud
